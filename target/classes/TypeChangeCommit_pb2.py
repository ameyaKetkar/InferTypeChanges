...
import Models.Models.TypeChangeAnalysis_pb2 as TypeChangeAnalysis__pb2
...
_TYPECHANGECOMMIT = _descriptor.Descriptor(
    ...
    nested_types=[_TYPECHANGECOMMIT_REFACTORINGSENTRY, _TYPECHANGECOMMIT_MIGRATIONANALYSIS,
                  _TYPECHANGECOMMIT_DEPENDENCYUPDATEIMPACT, ],
    enum_types=[
    ],
    serialized_options=None,
    is_extendable=False,
