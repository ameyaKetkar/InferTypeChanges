...
////    }
//
////    public TypFct(TypeNode s, Context context, Context gc) {
////        this.context = context;
...
////    }
////
////    public TypFct(TypeGraph typeGraph, Context context, Context gc) {
////        this.tg = typeGraph;
////        this.context = context;
////        qualify(gc);
////        this.context = null;
...
////    }
//
//    public void qualify(Context globalContext) {
...
//
//
////    private Optional<String> qualifyInternal(String lookup, String packageName, Context gc) {
...
////    }
//
////    private Optional<Tuple2<String, JarInfo>> qualifyExternal(String lookup, Context gc) {
...
////    }
//
//    private Optional<String> resolveAndQualify(String lookup, Context gc) {
//        return  qualifyAsTypeVariable(lookup)
//                .or(() -> qualifyQualified(lookup, gc))
////                .or(() -> qualifyAsClassName(lookup))
//                .or(() -> qualifyFromImports(lookup, context.getImportDecl()))
//                .or(() -> qualifyImportOnDemandJava(lookup, gc))
//                .or(() -> qualifyAsJavaLang(lookup, gc));
//    }
//
////    private Optional<String> qualifyInternalBruteForce(String lookup, Context gc) {
...
////    }
//
//    private Optional<String> qualifyImportOnDemandJava(String lookup, Context gc) {
...
//    }
//
//    private Optional<String> qualifyAsJavaLang(String lookup, Context gc) {
//        return// Optional.empty();
//                gc.getAllJavaLangClasses().filter(x -> x.endsWith(lookup)).findFirst()
//                .or(() -> gc.getJavaEnums().filter(x -> x.endsWith(lookup)).findFirst());
//    }
////
////    private Optional<String> qualifyFromPackage(String lookup, Context gc) {
...
////    }
//
//    private Optional<String> qualifyQualified(String lookup, Context gc) {
//        if (lookup.contains(".")) {
//            if (lookup.chars().filter(x -> x == '.').count() == 1) {
//                return resolveAndQualify(lookup.substring(0, lookup.indexOf(".")), gc)
