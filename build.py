...
def buildScript():
    ...
    o = subprocess.Popen("mvn install:install-file -Dfile=lib/RefactoringMiner-2.1.0.jar -DgroupId=org.rminer -DartifactId=AmeyaRMiner -Dversion=1.0 -Dpackaging=jar -DgeneratePom=true", shell=True).wait()
    o = subprocess.Popen("mvn clean install", shell=True).wait()
    os.system("pwd")
